...
public class Persistencia_UTL_Conversiones 
{
    //Atributos
    
    //Constructores
    public Persistencia_UTL_Conversiones()
    {
    ...
    public static void main(String[] args)
    {
        ...
        String cadena="0?z";//"1: a,5 c,4";//cadena ejemplo
        String resultado="";
        
        //Presentamos
        System.out.println("cadena original:    "+cadena);
        
//        resultado=objUtileria_Conversiones.ExtraerSubcadenaDeterminadaPorIndices(cadena, 1, cadena.length());
