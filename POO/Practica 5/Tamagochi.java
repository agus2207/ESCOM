...
private JButton feliz,enfermo,avatar1,avatar4,avatar2;
...
public Tamagochi(){
   ...
   avatar1=new JButton ("Contento");
   avatar1.addActionListener(eh);
   avatar4=new JButton("Pensantivo");
   avatar4.addActionListener(eh);
   avatar2=new JButton("Confundido");
   avatar2.addActionListener(eh);
...
class EventHandler implements ActionListener {  
  public void actionPerformed(ActionEvent e) { 
     ...
     if(obj instanceof JButton){ 
		...
		if(btn==enfermo) {turno=1;}
		if(btn==avatar1) {turno=2;}
		if(btn==avatar4) {turno=3;}
		if(btn==avatar2) {turno=4;}
...
public void leeRed(Object obj){
	...
	if(obj instanceof Mensaje){ 
		System.out.println("Recibí "+(Mensaje)obj);
