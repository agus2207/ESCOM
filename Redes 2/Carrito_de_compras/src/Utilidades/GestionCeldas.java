...
public class GestionCeldas extends DefaultTableCellRenderer{
	...
	private ImageIcon iconoComprar = new ImageIcon(getClass().getResource("/Imagenes/agregar.png"));
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        {
            if( String.valueOf(value).equals("BOTON") )
            {
            	label.setIcon(iconoComprar);
            }
...
//            return boton;
        ...
        if(tipo.equals("imagen")){
            imagen = new ImageIcon(getClass().getResource((String)value));
