...
public class DAT {
 ...
 /*public static void main(String[] args) throws IOException, ClassNotFoundException {
    ...
    array[0][3] = "400";
    array[0][4] = "3";
    array[0][5] = "/Imagenes/infinity_opt.jpg";
    ...
    array[1][3] = "250";
    array[1][4] = "2";
    array[1][5] = "/Imagenes/villa_opt.jpg";
    ...
    array[2][3] = "150";
    array[2][4] = "3";
    array[2][5] = "/Imagenes/stitch_opt.jpg";
    ...
    array[3][3] = "400";
    array[3][4] = "2";
    array[3][5] = "/Imagenes/iron_opt.jpg";
    ...
    array[4][3] = "350";
    array[4][4] = "3";
    array[4][5] = "/Imagenes/star_opt.jpg";
    ...
    array[5][3] = "500";
    array[5][4] = "3";
    array[5][5] = "/Imagenes/toy_opt.jpg";
    ...
    array[6][3] = "450";
    array[6][4] = "3";
    array[6][5] = "/Imagenes/avengers_opt.jpg";
    ...
    array[7][3] = "550";
    array[7][4] = "5";
    array[7][5] = "/Imagenes/ant_opt.jpg";
...
public void writeArray(String[][] array) throws IOException {
    try (ObjectOutputStream out = new ObjectOutputStream(
            new FileOutputStream("src/Documentos/base.dat"))) {

        out.writeObject(array);
    }
}

public String[][] readArray() throws IOException, ClassNotFoundException {
    try (ObjectInputStream in = new ObjectInputStream(
            new FileInputStream("src/Documentos/base.dat"))) {
