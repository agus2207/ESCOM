...
public class RSA {
    ...
    public void setPrivateKeyString(String key) throws Exception {
    ...
    public void setPublicKeyString(String key) throws Exception {
    ...
    public void genKeyPair(int size) throws Exception {
    ...
    public String Verify(String result) throws Exception {
    ...
    public void saveToDiskPrivateKey(String path) throws Exception {
    ...
    public void openFromDiskPublicKey(String path) throws Exception {
        String content = this.readFileAsString(path);
        this.setPublicKeyString(content);
    }

    public void openFromDiskPrivateKey(String path) throws Exception {
        String content = this.readFileAsString(path);
