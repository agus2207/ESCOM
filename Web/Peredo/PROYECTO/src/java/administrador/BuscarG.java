...
public class BuscarG extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Buscar grupo</title>");            
            ...
            out.println("<form method='get' action='ModElimG'>");
            out.println("<label for='groupb'>Grupo a buscar</label>");
            out.println("<input type='search' name='grupob'/>");
