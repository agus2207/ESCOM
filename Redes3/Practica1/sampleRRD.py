...
#formato de tiempo(posix) numero de segundos que han pasado apartir de epoc(01/01/1970)
#COUNTER:600 -> cuantas vueltas se deben de dar para descartar datos las vueltas se toman en cuenta dependiendo del step
#por defecto step = 300s. Se deifnen limites (superior, inferior) en este caso U simboliza indefinido
#RRA:AVERAGE -> se hace preprocesamiento de la informacion