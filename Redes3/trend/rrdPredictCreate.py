...
ret = rrdtool.create(rrdpath+rrdname,
            ...
            #RRA:HWPREDICT:rows:alpha:beta:seasonal period[:rra - num]
                     "RRA:HWPREDICT:1000:0.1:0.0035:200:3", #El 3 indica ue base de datos consultar en este caso los valores de seasonal
              #RRA:SEASONAL:seasonal period:gamma:rra-num
                     "RRA:SEASONAL:200:0.1:2", #El mismo numero de muestras en HWPREDICT y SEASONAL (200)
