...
; 0000 0033 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	OUT  0x1B,R30
; 0000 0034 
...
; 0000 0043 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0044 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=P Bit1=P Bit0=P
; 0000 0045 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(7)
	OUT  0x12,R30
; 0000 0046 
...
_0x31:
	BLD  R2,5
; 0000 00A2 
; 0000 00A3         if((botonp0==1)&&(botona0==0)) //Boton de reset
	SBRS R2,0
	RJMP _0xD
	SBRS R2,1
	RJMP _0xE
...
; 0000 00AB         }
; 0000 00AC         if((botonp1==1)&&(botona1==0)) //Boton de stop
_0xC:
	SBRS R2,2
	RJMP _0x10
	SBRS R2,3
...
; 0000 00AF            aux3 = 0;
	RCALL SUBOPT_0x0
; 0000 00B0            delay_ms(40);
; 0000 00B1         }
; 0000 00B2         if((botonp2==1)&&(botona2==0)) //Boton de start
_0xF:
	SBRS R2,4
	RJMP _0x13
	SBRS R2,5
...
; 0000 00B6            delay_ms(40);
	RCALL SUBOPT_0x1
; 0000 00B7         }
; 0000 00B8         if((botonp0==0) && (botona0==1))
_0x12:
	SBRC R2,0
	RJMP _0x16
	SBRC R2,1
...
_0x16:
	RJMP _0x15
_0x17:
; 0000 00B9             delay_ms(40);
	RCALL SUBOPT_0x1
; 0000 00BA         if((botonp1==0) && (botona1==1))
_0x15:
	SBRC R2,2
	RJMP _0x19
	SBRC R2,3
...
; 0000 00BB             delay_ms(40);
	RCALL SUBOPT_0x1
; 0000 00BC         if((botonp2==0) && (botona2==1))
_0x18:
	SBRC R2,4
	RJMP _0x1C
	SBRC R2,5
...
_0x1C:
	RJMP _0x1B
_0x1D:
; 0000 00BD             delay_ms(40);
	RCALL SUBOPT_0x1
; 0000 00BE         if(aux2==0 && aux3==0) // No se ha apretado ningun boton
_0x1B:
	TST  R5
	BRNE _0x1F
	TST  R4
...
; 0000 00C2             var3=0;
	CLR  R9
; 0000 00C3         }else if(aux2==1 && aux3==0){    // se ha apretado boton de reset
	RJMP _0x21
_0x1E:
	LDI  R30,LOW(1)
	CP   R30,R5
...
_0x23:
	RJMP _0x22
_0x24:
; 0000 00C4             PORTB=tabla7segmentos[var1];
	RCALL SUBOPT_0x2
; 0000 00C5             PORTA=~tabla7segmentos[var2];
; 0000 00C6             PORTC=tabla7segmentos[var3];
; 0000 00C7         }else if(aux2==0 && aux3==1){   //se ha apretado boton de start
	RJMP _0x25
_0x22:
	TST  R5
	BRNE _0x27
...
_0x27:
	RJMP _0x26
_0x28:
; 0000 00C8             delay_ms(1000*10);
	LDI  R26,LOW(10000)
	LDI  R27,HIGH(10000)
	RCALL _delay_ms
; 0000 00C9             var3++;
	INC  R9
; 0000 00CA             if(var3 == 10)
	LDI  R30,LOW(10)
	CP   R30,R9
	BRNE _0x29
; 0000 00CB             {
...
; 0000 00D3 
; 0000 00D4             }
; 0000 00D5             if(var1 == 5 && var2==9 && var3==9)
_0x2A:
	LDI  R30,LOW(5)
	CP   R30,R7
	BRNE _0x2C
...
_0x2B:
; 0000 00DC 
; 0000 00DD         botonp0=botona0;
_0x26:
_0x25:
_0x21:
	BST  R2,1
	BLD  R2,0
; 0000 00DE         botonp1=botona1;
	BST  R2,3
	BLD  R2,2
; 0000 00DF         botonp2=botona2;
	BST  R2,5
	BLD  R2,4
; 0000 00E0         PORTB=tabla7segmentos[var1];
	RCALL SUBOPT_0x2
; 0000 00E1         PORTA=~tabla7segmentos[var2];
; 0000 00E2         PORTC=tabla7segmentos[var3];
; 0000 00E3 
; 0000 00E4       }
	RJMP _0x3
; 0000 00E5 }
