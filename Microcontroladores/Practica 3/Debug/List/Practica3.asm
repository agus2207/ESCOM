...
; 0000 0025 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0026 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
...
; 0000 008B       variable=PIND&0x0f;
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 008C       variable1=PINC&0x0f;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 008D       if(variable<10)
	LDI  R30,LOW(10)
	CP   R5,R30
	BRSH _0x6
; 0000 008E         PORTB=tabla7segmentos[variable];
	MOV  R30,R5
	LDI  R31,0
...
_0x6:
	...
	CP   R4,R30
	BRSH _0x7
; 0000 0090         PORTA=~tabla7segmentos[variable1];
	MOV  R30,R4
	LDI  R31,0
	SUBI R30,LOW(-_tabla7segmentos*2)
	SBCI R31,HIGH(-_tabla7segmentos*2)
...
; 0000 0092         PORTB=0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 0093       if(variable1>=10)
_0x8:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRLO _0x9
; 0000 0094         PORTA=~0x79;
	LDI  R30,LOW(134)
	OUT  0x1B,R30
; 0000 0095 
; 0000 0096       }
