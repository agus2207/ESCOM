...
;#include <mega8535.h>
	...
	#endif
;#include <delay.h>
;#define receptor PINB.0
;#define entrada11 PORTD.0
;#define entrada12 PORTD.1
;#define enable1 PORTD.2
;#define entrada21 PORTD.3
;#define entrada22 PORTD.4
;#define enable2 PORTD.5
;int contador=0;
;int contMilis=0;
;
...
; 0000 0092       contador=0;
	CLR  R4
	CLR  R5
; 0000 0093       for(contMilis=0;contMilis<20;contMilis++){
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(20)
...
_0x8:
; 0000 009C 
; 0000 009D       if (contador>=1 && contador <=4)
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	RCALL SUBOPT_0x0
	BRLT _0xC
...
_0xD:
; 0000 009E          {
; 0000 009F           entrada11=1;
	SBI  0x12,0
; 0000 00A0           entrada12=0;
	CBI  0x12,1
; 0000 00A1           entrada21=0;
	CBI  0x12,3
; 0000 00A2           entrada22=0;
	CBI  0x12,4
; 0000 00A3           enable1=1;
	SBI  0x12,2
; 0000 00A4           enable2=0;
	RJMP _0x51
; 0000 00A5          }else if (contador>=5 && contador <=9){
_0xB:
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	RCALL SUBOPT_0x0
...
_0x1C:
	RJMP _0x1B
_0x1D:
; 0000 00A6           entrada11=0;
	CBI  0x12,0
; 0000 00A7           entrada12=1;
	SBI  0x12,1
; 0000 00A8           entrada21=0;
	CBI  0x12,3
; 0000 00A9           entrada22=0;
	CBI  0x12,4
; 0000 00AA           enable1=1;
	SBI  0x12,2
; 0000 00AB           enable2=0;
	RJMP _0x51
; 0000 00AC          }else if (contador>=10 && contador <=14){
_0x1B:
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL SUBOPT_0x0
...
_0x2C:
	RJMP _0x2B
_0x2D:
; 0000 00AD           entrada11=0;
	CBI  0x12,0
; 0000 00AE           entrada12=0;
	CBI  0x12,1
; 0000 00AF           entrada21=1;
	SBI  0x12,3
; 0000 00B0           entrada22=0;
	CBI  0x12,4
; 0000 00B1           enable2=1;
	SBI  0x12,5
; 0000 00B2           enable1=0;
	CBI  0x12,2
; 0000 00B3          }else if (contador>=15 && contador <=19){
	RJMP _0x3A
_0x2B:
	LDI  R30,LOW(15)
	LDI  R31,HIGH(15)
...
_0x3C:
	RJMP _0x3B
_0x3D:
; 0000 00B4           entrada11=0;
	CBI  0x12,0
; 0000 00B5           entrada12=0;
	CBI  0x12,1
; 0000 00B6           entrada21=0;
	CBI  0x12,3
; 0000 00B7           entrada22=1;
	SBI  0x12,4
; 0000 00B8           enable2=1;
	SBI  0x12,5
; 0000 00B9           enable1=0;
	CBI  0x12,2
; 0000 00BA          }else if (contador<=0){
	RJMP _0x4A
_0x3B:
	CLR  R0
	CP   R0,R4
