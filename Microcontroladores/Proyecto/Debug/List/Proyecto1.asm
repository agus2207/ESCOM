...
;#include <delay.h>
;
;#define btnIzquierda PINB.0
;#define btnDerecha   PINB.1
;#define btnDelante   PINB.2
;#define btnAtras     PINB.3
;#define salida       PORTD.0
;
...
; 0000 0090         delay_ms(10);
	...
	RCALL SUBOPT_0x0
; 0000 0091         salida=0;
; 0000 0092         delay_ms(190);
	LDI  R26,LOW(190)
	RJMP _0x1E
; 0000 0093       }else if (btnDerecha==0){
_0x6:
	SBIC 0x16,1
	RJMP _0xC
; 0000 0094         salida=1;
...
; 0000 0097         delay_ms(150);
	LDI  R26,LOW(150)
	RJMP _0x1E
; 0000 0098       }else if(btnDelante==0){
_0xC:
	SBIC 0x16,2
	RJMP _0x12
; 0000 0099         salida=1;
